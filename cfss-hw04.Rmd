...
First, let's find all the file names in the appropriate folder. We don't care about the names *per se* since they all end in `csv`. Remember to escape the period.

```{r}
files <- dir(path = "data_world_bank/", pattern = "\\.csv$")
files
```
